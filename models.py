...
def attempt_download(weights):
    ...
    msg = weights + ' missing, try downloading from https://drive.google.com/file/d/1KzANAdf7ok5lxKvQT2e9X1bluJs3OfQO/view?usp=sharing'

    if weights and not os.path.isfile(weights):
        d = {'a1.weights': '1KzANAdf7ok5lxKvQT2e9X1bluJs3OfQO/view?usp=sharing',
            }
