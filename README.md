...
Для автолейбелінгу ми створимо скрипт який за допомогою аугментації створить нам велетенську кучу даних і все шо нам потрібно це розмітити декілька якісних знімків, наприклад 5-10 штучок і це нам дозволить отримати наприклад 1000-5000
...
### The auto-labeling code example is in **./augmentaion** folder
